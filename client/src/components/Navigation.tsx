...
export function Navigation() {
  ...
  //     if (event.data === 'changeAccessMenu') {
  //       callServerAPI();
  //     }
  //   };
  ...
  console.log('accessMenuList', accessMenuList);
  ...
  console.log(
    accessMenuList.filter((menu) => menu.menuCode === 'QM')[0]?.isUse,
  );
  return (
    <>
      {isOpenNavigation ? (
