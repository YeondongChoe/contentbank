...
export function QuizElementList({
                ...
                {(dragItem, ref, isDragging) => (
                  ...
                  >
                    <CheckBoxI
                      ...
                      value={dragItem.code}
                    />
                    {/* {dragItem.type === 'BIG' && <strong></strong>}
                    {dragItem.type === 'TEXT' && <strong></strong>}
                    {dragItem.type === 'QUESTION' && <strong></strong>}
                    {dragItem.type === 'SMALL' && <strong></strong>}
                    {dragItem.type === 'EXAMPLE' && <strong></strong>}
                    {dragItem.type === 'CHOICES' && <strong></strong>}
                    {dragItem.type === 'ANSWER' && <strong></strong>}
                    {dragItem.type === 'COMMENTARY' && <strong></strong>}
                    {dragItem.type === 'HINT' && <strong></strong>}
                    {dragItem.type === 'CONCEPT' && <strong></strong>}
                    {dragItem.type === 'TITLE' && <strong></strong>}
                    {dragItem.type === 'TIP' && <strong></strong>} */}
                    <PerfectScrollbar>
                      <MathViewerWrapper>
